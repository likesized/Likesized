...
set local request.jwt.claim.sub='f5200000-0000-4000-8000-000000000001';
set local request.jwt.claim.role='authenticated';
select is((select count(*) from public.get_following_feed(50,null)),3::bigint,'Following Feed returns only followed-member meaningful activity');
...
reset role;
select is((select count(*) from private.following_activity_events where closet_item_id='f5230000-0000-4000-8000-000000000002'::uuid),0::bigint,'making a garment Private removes its prior feed ledger events');
