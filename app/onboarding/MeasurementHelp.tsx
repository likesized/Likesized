...
const HELP: Record<string, HelpItem> = {
  ...
  front_waist_length: { title: "Front Waist Length", description: "The distance from the high shoulder point to the natural waist along the front of the body.", how: "Start at the high shoulder point where the neck meets the shoulder. Measure down the front of the body, over the fullest part of the bust, to the natural waist.", guide: { kind: "body", mode: "polyline", points: "140,64 128,104 128,136" } },
