...
8. Saved Fit Twins
9. Auth + privacy settings (before public beta)
...
Fit Twin/profile surfaces are member-facing in the current V1. Anonymous public-profile visibility should not be enabled until explicit privacy controls exist.
