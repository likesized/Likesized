...
import { saveFitTwinNotificationSettings, saveProfileSettings } from "@/app/settings/actions";
...
export default async function SettingsPage({searchParams}:{searchParams:SearchParams}){
  ...
  const errorMessage=error==="invalid_profile"?"Display name or bio is too long.":error==="save_failed"?"Your profile settings could not be saved.":error==="notification_save_failed"?"Your notification preference could not be saved.":null;
