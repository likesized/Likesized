...
test("only explicitly non-runtime canonical files may skip a production build", () => {
  ...
  for (const runtimePath of ["app/", "components/", "lib/", "public/", "supabase/migrations/", "package.json", "vercel.json"])
