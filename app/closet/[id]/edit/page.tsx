  ...
  return <main className="pageShell">
    ...
    <section className="section"><div className="sectionHeading"><div><span className="eyebrow">FIT NOW</span><h2>Log a new fit observation</h2><p>This records how the same garment physically fits your current body. Log failures too—Too Small and Too Big are useful sizing evidence and never reduce the wearer’s body Match %.</p></div></div>
      <form className="garmentForm" action={logFitObservation}><input type="hidden" name="closet_item_id" value={id}/>
        ...
        <div className="privacyNote">Changed garments stay in your Fit History, but LikeSized does not treat their altered fit as typical evidence for a new copy of the product.</div>
        <FitDimensionFields garmentType={product?.garment_type_key} dimensions={dimensions} responses={responses??[]}/><label>Fit notes <span className="muted inlineMuted">optional</span><textarea name="fit_notes" maxLength={1000} rows={4} placeholder="How does it fit now?"/></label><button className="primaryButton" type="submit">Save new fit observation</button></form>
    </section>
