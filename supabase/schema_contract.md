...
The Fit Match audit branch contains **38 migrations** from `20260819132934_initial_likesized_schema.sql` through `20260820222100_bust_shaping_context.sql`. The newest garment/matching migrations are `20260820203500_garment_enrichment_provenance.sql`, `20260820211800_directional_fit_recommendation.sql`, `20260820215500_garment_fit_preferences.sql`, `20260820221000_derived_body_proportion_refinement.sql`, and `20260820222100_bust_shaping_context.sql`. These branch migrations are not production-applied until owner-authorized merge/deployment.
