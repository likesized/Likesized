...
export default async function MyCirclePage(){
  ...
  if(profileError||fitProfileError||feedError)throw new Error("Could not load My Circle.");
  ...
  return <main className="pageShell">
    ...
    <div className="pageTitle">
      <span className="eyebrow">FOLLOWING ACTIVITY</span>
      <h2>Updates from the people you choose to follow.</h2>
    </div>
