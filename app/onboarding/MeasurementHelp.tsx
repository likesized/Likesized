...
const HELP: Record<string, HelpItem> = {
  ...
  shoulder_to_bust_point: { title: "Shoulder to Bust Point", description: "The distance from the high shoulder point to the bust point.", how: "Measure the vertical distance from the middle of your shoulder—where a bra strap naturally sits—down to the fullest part or nipple of the bust.", guide: { kind: "body", mode: "line", x1: 140, y1: 64, x2: 126, y2: 104 } },
