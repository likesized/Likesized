-- LikeSized canonical migration: garment enrichment provenance.
-- Product facts become progressively trustworthy without allowing one member submission
-- to silently become verified catalog truth. Physical Fit Result remains the sizing signal.
...
-- Exact-product physical Fit Result summary. One latest Shared observation per unique
