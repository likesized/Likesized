...
export default async function NewOutfitPage({searchParams}:{searchParams:SearchParams}){
  ...
  const params=await searchParams; const error=first(params.error); const preselectedClosetItemId=first(params.closet_item_id)??"";
