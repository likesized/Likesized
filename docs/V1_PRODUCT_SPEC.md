...
- With **one or more Relevant Fit Reports but insufficient recommendation confidence**, the quick view uses the owner-approved wording **“Not enough fit data to confidently recommend a size.”**, shows **Relevant Fit Reports: X**, and directly shows the single best available exact report. With enough evidence to recommend, the quick view uses **“Our FITuition suggests: [SIZE]”** and **“Confidence: [label]”**. If a compact **Strong Fit Reports** aggregate exists, the recommendation state shows that aggregate as count + Size + Fit Result rows **instead of an individual closest report**. If no Strong aggregate exists, it shows **Relevant Fit Reports: X** plus the single best available exact report.
