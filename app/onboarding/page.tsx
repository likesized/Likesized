...
export default async function OnboardingPage({searchParams}:{searchParams:SearchParams}){
  ...
  return <main className={`onboardingShell ${isInitialSetup?"":heroStyles.revisitShell}`}>
    ...
    <FitProfileForm username={profile?.username??""} isInitialSetup={isInitialSetup} unitSystem={unitSystem} fitCommunity={fitCommunity as FitCommunity} types={(types??[]) as MeasurementType[]} measurements={(measurements??[]) as BodyMeasurement[]} errorMessage={errorMessage}/>
  </main>;
}