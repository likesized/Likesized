...
test("New Outfit has one canonical creator and no legacy private/share conversion", () => {
...
test("V1 social controls include comments, reporting, blocking and the locked creator analytics", () => {
  ...
  assert.match(migration, /private\.outfit_shop_clicks/);
  assert.match(migration, /comments_enabled/);
});
