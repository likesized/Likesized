-- Fix PL/pgSQL output-column ambiguity in the garment-relevant body baseline inserts.
-- The previous migration is already applied; keep it immutable and replace only
-- the affected RPC definition here.
